      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="glass-panel p-10 rounded-[2.5rem] border border-white/5 bg-white/5 backdrop-blur-3xl shadow-2xl">
          <div className="flex flex-col items-center mb-10">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center shadow-lg mb-6">
              <span className="font-black text-white text-lg">AI</span>
            </div>
            <h1 className="text-3xl font-black tracking-tight mb-2 text-center">Join the Elite</h1>
            <p className="text-white/40 text-sm font-medium">Elevate your interview performance</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                type="email"
                required
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-sm focus:outline-none focus:border-purple-500/50 transition-all"
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black tracking-widest uppercase text-white/40 px-1">Create Password</label>
              <input
                type="password"
                required
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-sm focus:outline-none focus:border-purple-500/50 transition-all"
